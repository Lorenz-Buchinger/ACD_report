...
\subsection{Curves \& Diagrams}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\linewidth]{img/e_lab_3/picture_22.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\linewidth]{img/e_lab_3/picture_23.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{img/e_lab_4/picture_24_Rg_GND.png}
    ...
    \begin{figure}[H]
        \centering
        \includesvg[inkscapelatex=false, width=1\linewidth]{img/e_lab_3/EL3_bode3}
